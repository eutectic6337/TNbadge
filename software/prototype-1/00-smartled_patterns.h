// Each of the badge's 5 cities must have:
//    const double brightness_sequence_speed_CITYNAME=BRIGTNESS_SPEED_MULTIPLIER;
//    struct brightness_transition brightness_tx_CITYNAME [] = {comma-separated-sequence-of-brightness-transitions};
//
//    const double color_sequence_speed_CITYNAME=COLOR_SPEED_MULTIPLIER;
//    struct color_transition color_tx_CITYNAME [] = {comma-separated-sequence-of-color-transitions};
...
// The speed multiplier determines the speed at which the sequence of transitions runs
